        ...
        <>
            ...
            <div className="w-11/12 px-2 sm:px-10 pb-10 mx-auto">
                ...
                <div className="text-gray-700 text-start w-full">
                    ...
                    <p className="pb-1">
                        Das rasche Wirtschaftswachstum und die zahlreichen Beschäftigungsmöglichkeiten in den Bereichen IT, 
                        Technik und Industrie. Im Vergleich zu anderen Ländern bietet das Land faire Löhne und Gehälter. Und die 
                        deutsche Regierung bemüht sich kontinuierlich darum, Ausländer als Arbeitskräfte zu gewinnen.
                    </p>
                    ...
                    <p className="pb-1">
                        ...
                        Sie sind die wichtigsten Einnahmequellen des Staates, mit denen er Ausgaben für das Gemeinwohl finanziert, wie z. 
                        B. soziale Sicherheit, Bildung, Gesundheitsversorgung oder Verkehrsinfrastruktur. Das deutsche Steuersystem basiert 
                        auf der Leistungsfähigkeit des einzelnen Steuerzahlers, Transparenz und Gerechtigkeit.
                    </p>
                </div>
            </div>
